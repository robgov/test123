...
namespace ProviderApi.Models
{
  public partial class AEDMContext : DbContext
  {
    ...
    public AEDMContext(DbContextOptions<AEDMContext> options, IConfiguration configuration)
        : base(options)
    {
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
      ...
      {
        optionsBuilder.UseSqlServer(_configuration.GetConnectionString("TheJunConnection")); ;
      }
    }
