...
namespace ProviderApi.Controllers
{
  ...
  public class InstitutionSummaryController : ControllerBase
  {
    ...
    public IEnumerable<VwInstitutionSummary> GetInstitution(int id)
    {
    ...
    [SwaggerResponse((int)HttpStatusCode.OK)]
    [SwaggerResponse((int)HttpStatusCode.NotFound)]
    public IEnumerable<VwInstitutionSummary> GetInstitutionByPIN(int pin)
    {
    ...
    [SwaggerResponse((int)HttpStatusCode.OK)]
    [SwaggerResponse((int)HttpStatusCode.NotFound)]
    public IEnumerable<VwInstitutionSummary> QueryInstitnutions([FromQuery] InstitutionsParameters institutionSummaryParameters)
    {
